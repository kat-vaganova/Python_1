...
class Kletka:
    ...
    def __init__(self, count):
        self.count = count  # кол-во ячеек в клетке
        # self.row = row   # кол-во ячеек в ряду

    def __add__(self, other):  # сложение
        return f"Сложение, размер клетки: {self.count + other.count} ячеек"

    def __sub__(self, other):  # вычитание
        return f"Вычитание, размер клетки: {self.count - other.count} ячеек"

    def __mul__(self, other): # умножение
        return f"Умножение, размер клетки: {self.count * other.count} ячеек"

    def __truediv__(self, other): # деление
        return f"Деление, размер клетки: {self.count // other.count} ячеек"
